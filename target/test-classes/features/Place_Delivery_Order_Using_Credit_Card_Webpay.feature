 @reset @regression @website @placeorderccwebpay

Feature: Place Delivery Order from Woolworths Online Using Credit Card - Webpay Payment Method

  Scenario: Place Delivery Order from Woolworths Online Using Credit Card - Webpay Payment Method

    Given I am on the Woolworths home page
    When I click on "Login" on home page
    And I provide username and password for "Webpay1 Payment"
