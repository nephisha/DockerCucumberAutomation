 @reset @regression @website @placeorderbundles

Feature: Place Delivery Bundle Order from Woolworths Online Using Credit Card - Webpay Payment Method

  Scenario: Place Delivery Bundle Order from Woolworths Online Using Credit Card - Webpay Payment Method
    Given I am on the Woolworths home page
    When I click on "Login" on home page
    And I provide username and password for "Webpay Payment"
    ...
    And I search for "Bundles" stockcode
